...
public class JobParameter extends JPanel {
	...
	public JobParameter(Parameter parameter) {
		setLayout(null);

		jobWage = parameter.getJobWage();

		JLabel label = new JLabel("\u5C97 \u4F4D \u5DE5 \u8D44");
		label.setFont(new Font("微软雅黑", Font.PLAIN, 22));
		label.setBounds(265, 30, 166, 40);
		add(label);
		...
		label_6.setBounds(22, 161, 92, 21);
		add(label_6);
		...
		label_4.setBounds(426, 221, 66, 20);
		add(label_4);
		...
		teacher.setBounds(138, 220, 128, 23);
		add(teacher);
		...
		president.setBounds(138, 160, 128, 23);
		add(president);
		...
		label_8.setBounds(0, 286, 134, 21);
		add(label_8);

		director = new JTextField();
		director.setText(jobWage[6]);
		director.setColumns(10);
		director.setBounds(138, 285, 128, 23);
		add(director);
