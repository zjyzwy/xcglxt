...
public class UserInfoUpdate extends JPanel {
	...
	public UserInfoUpdate(User user) {
		...
		setComboBoxValue(professionalTitle, user.getProfessionalTitle());
		...
		setComboBoxValue(sex, user.getSex());
		add(sex);
		...
		setComboBoxValue(mTAO_State, user.getmTOA_State());
		add(mTAO_State);
		
		JComboBox baseAllowanceState = new JComboBox();
		baseAllowanceState.setModel(new DefaultComboBoxModel(new String[] {"\u8BF7\u9009\u62E9", "\u9662\u957F", "\u4E66\u8BB0", "\u526F\u9662\u957F", "\u526F\u4E66\u8BB0", "\u6559\u6388", "\u526F\u6559\u6388", "\u8BB2\u5E08", "\u52A9\u6559", "\u7CFB\u4E3B\u4EFB", "\u5DE5\u4F1A\u4E3B\u5E2D", "\u7CFB\u90E8\u4E3B\u4EFB", "\u529E\u516C\u5BA4\u4E3B\u4EFB", "\u56E2\u59D4\u4E66\u8BB0", "\u5B66\u672F\u59D4\u4E3B\u4EFB\u59D4\u5458", "\u9662\u957F\u52A9\u7406"}));
		baseAllowanceState.setFont(new Font("宋体", Font.BOLD, 16));
		baseAllowanceState.setBounds(474, 194, 129, 24);
		setComboBoxValue(baseAllowanceState, user.getBaseAllowanceState());
		add(baseAllowanceState);
		
		JComboBox dutyAllowanceState = new JComboBox();
		dutyAllowanceState.setModel(new DefaultComboBoxModel(new String[] {"\u8BF7\u9009\u62E9", "\u9662\u957F", "\u4E66\u8BB0", "\u526F\u9662\u957F", "\u526F\u4E66\u8BB0", "\u6559\u6388", "\u526F\u6559\u6388", "\u8BB2\u5E08", "\u52A9\u6559", "\u7CFB\u4E3B\u4EFB", "\u5DE5\u4F1A\u4E3B\u5E2D", "\u529E\u516C\u5BA4\u4E3B\u4EFB", "\u56E2\u59D4\u4E66\u8BB0", "\u7EE7\u6559\u529E\u4E3B\u4EFB", "\u5404\u4E2D\u5FC3\u4E3B\u4EFB", "\u9662\u957F\u52A9\u7406", "\u5B66\u672F\u59D4\u4E3B\u4EFB\u59D4\u5458"}));
		dutyAllowanceState.setFont(new Font("宋体", Font.BOLD, 16));
		dutyAllowanceState.setBounds(474, 255, 129, 24);
		setComboBoxValue(dutyAllowanceState, user.getDutyAllowanceState());
		add(dutyAllowanceState);
		
		JComboBox telAllowanceState = new JComboBox();
		telAllowanceState.setModel(new DefaultComboBoxModel(new String[] {"\u8BF7\u9009\u62E9", "\u9662\u957F", "\u4E66\u8BB0", "\u526F\u9662\u957F", "\u526F\u4E66\u8BB0", "\u6559\u6388", "\u526F\u6559\u6388", "\u8BB2\u5E08", "\u52A9\u6559", "\u7CFB\u4E3B\u4EFB", "\u9662\u957F\u52A9\u7406", "\u5DE5\u4F1A\u4E3B\u5E2D", "\u529E\u516C\u5BA4\u4E3B\u4EFB", "\u56E2\u59D4\u4E66\u8BB0", "\u5B66\u672F\u59D4\u4E3B\u4EFB\u59D4\u5458", "\u7EE7\u6559\u529E\u4E3B\u4EFB", "\u5404\u4E2D\u5FC3\u4E3B\u4EFB", "\u9662\u957F\u52A9\u7406"}));
		telAllowanceState.setFont(new Font("宋体", Font.BOLD, 16));
		telAllowanceState.setBounds(474, 304, 129, 24);
		setComboBoxValue(telAllowanceState, user.getTelAllowanceState());
		...
		loginAuthority.setModel(new DefaultComboBoxModel(new String[] {"\u9662\u957F", "\u4E66\u8BB0", "\u526F\u9662\u957F", "\u526F\u4E66\u8BB0", "\u6559\u6388", "\u526F\u6559\u6388", "\u8BB2\u5E08", "\u52A9\u6559", "\u7CFB\u4E3B\u4EFB", "\u8D22\u52A1\u5458"}));
		loginAuthority.setBounds(329, 357, 83, 24);
		setComboBoxValue(loginAuthority, user.getLoginAuthority());
		add(loginAuthority);
		
		JButton createUserBt = new JButton("\u521B \u5EFA \u7528 \u6237");
		createUserBt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(n==1) {
					JOptionPane.showMessageDialog(null, "创建用户成功", "提示信息",JOptionPane.OK_OPTION);
				}else {
					JOptionPane.showMessageDialog(null, "创建用户失败", "提示信息",JOptionPane.WARNING_MESSAGE);
				}
			}
		});
		createUserBt.setFont(new Font("宋体", Font.BOLD, 16));
		createUserBt.setBounds(176, 415, 135, 27);
		add(createUserBt);
		
		JButton update = new JButton("\u66F4 \u65B0 \u7528 \u6237");
		update.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(n==1) {
					JOptionPane.showMessageDialog(null, "更新用户信息成功", "提示信息",JOptionPane.OK_OPTION);
				}else {
					JOptionPane.showMessageDialog(null, "更新用户信息失败", "提示信息",JOptionPane.WARNING_MESSAGE);
				}
			}
		});
		update.setFont(new Font("宋体", Font.BOLD, 16));
		update.setBounds(399, 415, 129, 27);
		add(update);
		
		JButton button1 = new JButton("\u66F4\u65B0\u7528\u6237\u56FE\u50CF");
		...
		button1.setBounds(444, 356, 157, 27);
		add(button1);

	}

	private void setComboBoxValue(JComboBox cmb, String value) {
		// TODO 自动生成的方法存根
