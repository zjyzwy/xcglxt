...
//			user.setLoginAuthority(x.get(11));
	...
	public int addUser(User user) {
		...
		String sql1 = "userId,userName,psw,sex,department,post,professionalTitle,mTAO_State,baseAllowanceState,dutyAllowanceState,telAllowanceState,loginAuthority";
	...
	public User createUser(Vector<String> v) {
		User user = new User();
		user.setUserId(v.get(0));
		user.setUserName(v.get(1));
		user.setUserPsw(v.get(2));
